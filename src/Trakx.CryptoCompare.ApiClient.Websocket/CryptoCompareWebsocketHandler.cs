...
namespace Trakx.CryptoCompare.ApiClient.Websocket
{
    public class CryptoCompareWebsocketHandler : ClientWebsocketRedirectHandlerBase<InboundMessageBase>, ICryptoCompareWebsocketHandler
    {
        ...
        public CryptoCompareWebsocketHandler(IOptions<WebsocketConfiguration> websocketConfigurationOption,
            CryptoCompareWebsocketConfiguration config,
            IClientWebsocketFactory clientWebsocketFactory,
            TaskScheduler taskScheduler = null) : base(websocketConfigurationOption, clientWebsocketFactory, taskScheduler)
        {
            _config = config;
        }
